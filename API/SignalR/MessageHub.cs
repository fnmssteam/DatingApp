...
public class MessageHub : Hub
{
    ...
    public async Task SendMessage(CreateMessageDto createMessageDto)
    {
        ...
        // If the recipient is currently in a connection (i.e. currently looking at the message thread) within the group
        if (group.Connections.Any(x => x.Username == recipient.UserName))
        {
            ...
            if (connections != null)
            {
                // Send the message via presence hub to notify recipient using a different method (ex. toast)
